...
class ResCompany(models.Model):
    ...
    report_template_id = fields.Many2one('ir.actions.report.xml' , string="Default Invoice Template", default=_default_report_template, help="Please select Template report for Invoice", domain=[('model', '=', 'account.invoice')])
