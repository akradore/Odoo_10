    ...
    var reports_view_horizontal = Widget.extend(ControlPanelMixin, {
        ...
        find_child: function (el, line, line_type, self) {
            ...
            if (line_type != 'journal_item' && line_type != 'account'){
                ...
                if(current_line){
//                Changed by milind frm category to journal_items
...
//            Changed by milind from category to journal_items
                for (var i in journal_items){
...
//                Changed by milind from records[1][0] to records[0][1]
                this.left = records[0][0];
                this.right = records[0][1];
            }
